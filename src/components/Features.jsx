...
import { faWandSparkles, faFileText, faHatWizard, faTerminal, faBox, faLayerGroup, faLightbulb, faKey } from '@fortawesome/free-solid-svg-icons';
  ...
  const features = [
    {
      ...
      description: "Automatically creates a detailed README.md by analyzing your project's content.",
    ...
    },
    {
      ...
      description: "If you run the tool without commands, a user-friendly wizard guides you through the options.",
    ...
    },
    {
      ...
      description: "Fetches details from package.json to inform documentation generation.",
    ...
    <Box className="py-24 relative">
      ...
      <Container maxWidth="lg" className="relative z-10">
                  ...
                  <Box className="space-y-2 text-sm">
                    <Box className={`flex items-center gap-2 ${
                      ...
                      <Typography variant="body2" sx={{ fontSize: '0.875rem' }}>
                        ...
                        <span className="text-cyan-400 font-medium">Google AI Studio</span>
                      </Typography>
                    </Box>
                    <Box className={`flex items-center gap-2 ${
                      isDarkMode ? 'text-gray-400' : 'text-gray-600'
                      ...
                      <Box className="w-1.5 h-1.5 bg-cyan-400 rounded-full"></Box>
                      <Typography variant="body2" sx={{ fontSize: '0.875rem' }}>
                        Create a <code className={`px-1 py-0.5 rounded font-mono ${
                          isDarkMode ? 'bg-gray-800 text-cyan-300' : 'bg-gray-200 text-cyan-700'
                        }`}>.env</code> file in your project directory
                      </Typography>
                    </Box>
                    <Box className={`flex items-center gap-2 ${
                      isDarkMode ? 'text-gray-400' : 'text-gray-600'
        ...
        <Box className="text-center mb-16 mt-24">
          ...
          >
            Everything you need to create professional documentation effortlessly
          </Typography>
        </Box>
