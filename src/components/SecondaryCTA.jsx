...
import { Box, Typography, Container, Button, Snackbar, Alert, Paper } from '@mui/material';
      ...
      <Container maxWidth="lg" className="relative z-10">
        ...
        <Box className="text-center">
          ...
          >
            Ready to Eliminate
            <br />
            <span className={isDarkMode ? 'text-emerald-400' : 'text-emerald-600'}>Documentation Hassles?</span>
          </Typography>
          ...
          >
            Join thousands of developers who have already streamlined their documentation workflow. 
